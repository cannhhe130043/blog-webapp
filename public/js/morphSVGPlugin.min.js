...
!(function (t, e) {
    ...
    if (t !== r || e !== h) {
      ...
      for (z = 0; z < X; z++)
        (_ = F((s = N + z * I))),
          ...
          (M = F((s += I))),
          (D = W(s)),
          O.push(_ - G * m, m + G * _, M + G * D, D - G * M, M, D)
      for (z = 0; z < O.length; z += 2)
        (_ = O[z]),
          (m = O[z + 1]),
          (O[z] = _ * V + m * Y + E),
          (O[z + 1] = _ * q + m * B + k)
  ...
  function bezierToPoints(t, e, n, i, s, a, o, r, h, l, c) {
    ...
    return (
      ...
      h * (x * x + S * S) < (C + E) * (C + E) &&
        ((d = l.length),
        bezierToPoints(t, e, u, p, v, b, A, w, h, l, c),
      ...
      (i = b),
        ...
        (b === i && y === s) ||
          (n < a
            ...
            : ((r = E(d, l)),
              w.push(o(b - F(r) * p), o(y - W(r) * p)),
              (r = E(S, x)),
              w.push(o(b), o(y), o(b + F(r) * g), o(y + W(r) * g))))
    return (
      w.push(o(P), o(A), o(P), o(A)),
      C && (w.splice(0, 6), (w.length = w.length - 6)),
      w
    )
  }
  ...
  function J(t, e) {
    if (t.parentNode && (u || B(t))) {
      var n = H(t),
        ...
        h = u.createElementNS
          ? u.createElementNS(i.replace(/^https/, 'http'), s)
          : u.createElement(s)
      return (
        e &&
          (n
    ...
    if ((l.length || l.push(J(t, 1), J(t, 2), J(t, 3)), (n = r ? d : c), r))
      ...
      if (((a = o = 0), v))
        for (
          ...
          4 < (g.getComputedStyle(s)[b] + '').length &&
  ...
  function getGlobalMatrix(t, e, n) {
    ...
    if ((l.removeChild(a), i))
      for (o = i.length; o--; )
        ((r = i[o]).scaleX = r.scaleY = 0), r.renderTransform(1, r)
  ...
  function Ba(t) {
    ;(a = t.touches && _dragCount < t.touches.length),
      za(t.target, 'touchend', Ba)
  }
  function Ca(t) {
    ;(a = t.touches && _dragCount < t.touches.length),
      ya(t.target, 'touchend', Ba)
  }
  function Da(e, n) {
    return function (t) {
      return e.call(n, t)
  ...
  function La(t, e) {
    ...
    if (
      ...
      if (
        (r
          ? (za(r, 'touchend', n._onRelease),
            za(r, 'touchmove', n._onMove),
            za(r, 'touchcancel', n._onRelease),
            za(D, 'touchstart', Ca))
          : za(D, 'mousemove', n._onMove),
        h ||
          (za(D, 'mouseup', n._onRelease),
          t && t.target && za(t.target, 'mouseup', n._onRelease)),
        o
          ? (n.isDragging = !1)
  ...
  var D,
    ...
    rt =
      (((n =
        DraggableSVG.prototype).setPointerPosition = function setPointerPosition(
        t,
        e
      ) {
        var n, i, s, a, o
        ;(this.pointerX = t),
          ...
          (this.x === s && this.y === a) ||
            ...
            !this.isDragging &&
              this.isPressed &&
              ((this.isDragging = !0),
              Ea('onDragStart', this, this.pointerEvent)))
      }),
      (n.enabled = function enabled(t) {
        return arguments.length
          ? ((this._enabled = t)
              ? (h || ya(this.target, 'mousedown', this._onPress),
                ya(this.target, 'touchstart', this._onPress),
                ya(this.target, 'click', this._onClick, !0))
              : ((e = this.isDragging),
                ...
                this.touchEventTarget &&
                  (za(this.touchEventTarget, 'touchcancel', this._onRelease),
                  za(this.touchEventTarget, 'touchend', this._onRelease),
                  za(this.touchEventTarget, 'touchmove', this._onMove)),
      ...
      (ht.update = function update(t, e, n) {
        ...
        ;(this.segment = s),
          (this.smooth =
            ...
            n < s.length - 2 &&
            Math.abs(
              Math.atan2(s[n + 1] - s[n - 1], s[n] - s[n - 2]) -
  ...
  function Anchor(t, e, n, i, s) {
    ;(this.editor = t),
      (this.element = ma('path', t._selection, {
        fill: Y,
        stroke: Y,
        strokeWidth: 2,
    ...
    dt =
      ...
      (ct.init = function init() {
        ...
        if (((this._rawPath = i), a)) {
          if (((this._anchors = Ma(i, 0, this, o)), 1 < (t = i.length)))
            for (e = 1; e < t; e++)
              this._anchors = this._anchors.concat(Ma(i, e, this, o))
        } else
        ...
        return (
          ...
          this._g.setAttribute(
            ...
            (function _getConcatenatedTransforms(t) {
              for (
                var e = oa(t), n = t.ownerSVGElement;
      ...
      (ct.select = function select(t) {
        ...
        return (
          -1 === ot.indexOf(this) && ot.push(this), this._updateAnchors(), this
        )
      }),
      ...
      (ct._onPressAnchor = function _onPressAnchor(t) {
        ;-1 === this._selectedAnchors.indexOf(t)
          ? (N || (this._selectedAnchors.length = 0),
      ...
      (ct._onClickAnchor = function _onClickAnchor(t) {
        ...
        R && X !== t && this._editingAnchor
          ? ((t.smooth = !t.smooth),
            ...
            t.smooth && !c
              ? ((e =
                  ((e = Math.atan2(h[r + 1] - h[r - 1], h[r] - h[r - 2])) +
                ...
                i < 0.2 &&
                  ((i = Na(h, r, r - 6) / 4),
                  (e =
                    n || Math.atan2(h[r + 7] - h[r - 5], h[r + 6] - h[r - 6]))),
                s < 0.2 &&
                  ((s = Na(h, r, r + 6) / 4),
                  (n =
                    e || Math.atan2(h[r + 7] - h[r - 5], h[r + 6] - h[r - 6]))),
                (a = Math.sin(e)),
                (o = Math.cos(e)),
      ...
      (ct._updateAnchors = function _updateAnchors() {
        ...
        for (this._editingAnchor = i, t = 0; t < this._anchors.length; t++)
          this._anchors[t].element.style.fill =
            -1 !== this._selectedAnchors.indexOf(this._anchors[t]) ? Y : 'white'
        i &&
        ...
        if (
          ...
          for (e = 0; e < this._rawPath.length; e++)
            7 < (n = this._rawPath[e]).length &&
              (a += 'M' + n[0] + at + n[1] + 'C' + n.slice(2).join(at))
          this.path.setAttribute('d', a),
            this._selectionPath.setAttribute('d', a),
            this._selectionHittest.setAttribute('d', a)
        }
        return (
          this.vars.onUpdate && this._enabled && Ea('onUpdate', this, a), this
        )
      }),
      ...
      (ct.getNormalizedSVG = function getNormalizedSVG(t, e, n, i) {
        var s,
          ...
          f = -t || c[p - 1] + u
        for (
          f = f ? 1 / f : -g, g *= 1e3, f *= 1e3, a = st.length = 0;
          a < p;
          a += 2
        )
          (st[a] = (((c[a] + d) * g) | 0) / 1e3),
            (st[a + 1] = (((c[a + 1] + u) * f) | 0) / 1e3)
        if (i) {
  ...
  function PathEditor(t, e) {
    ;(e = e || {}),
        ...
        (function _initCore() {
          ;(D = document),
            ...
            (I = (function (t) {
              for (
                var e = t.split(','),
                  n = (void 0 !== O.onpointerdown
                    ? 'pointerdown,pointermove,pointerup,pointercancel'
                    : void 0 !== O.onmspointerdown
            ...
            D.addEventListener(
              ...
              function (t) {
                ...
                if ('Shift' === o || 16 === a) N = !0
                  ...
                  for (R = !0, e = ot.length; -1 < --e; ) ot[e]._onPressAlt()
                  ...
                  for (e = ot.length; -1 < --e; ) ot[e]._deleteSelectedAnchors()
                else if (('a' === o || 65 === a) && (z || l))
                  for (e = ot.length; -1 < --e; ) ot[e].select(!0)
              },
              !0
            ),
            D.addEventListener(
      ...
      (this._g = ma('g', this.path.ownerSVGElement, {
        class: 'path-editor-g path-editor',
      })),
      (this._selectionHittest = ma('path', this._g, {
        stroke: 'transparent',
        strokeWidth: 16,
        fill: 'none',
        vectorEffect: 'non-scaling-stroke',
      ...
      (this._selection =
        e._selection ||
        ma('g', this._g, { class: 'path-editor-selection path-editor' })),
      (this._selectionPath = ma('path', this._selection, {
        stroke: Y,
        strokeWidth: 2,
        fill: 'none',
        vectorEffect: 'non-scaling-stroke',
      ...
      (this._line1 = ma('polyline', this._selection, {
        stroke: Y,
        strokeWidth: 2,
        vectorEffect: 'non-scaling-stroke',
      })),
      (this._line2 = ma('polyline', this._selection, {
        stroke: Y,
        strokeWidth: 2,
        vectorEffect: 'non-scaling-stroke',
      })),
    ...
    ;(this._squareHandle = (function _getSquarePathData(t) {
      ...
      (this._handle1 = ma('path', this._selection, {
        d: this._squareHandle,
        fill: Y,
        stroke: 'transparent',
        strokeWidth: 6,
      })),
      (this._handle2 = ma('path', this._selection, {
        d: this._squareHandle,
        fill: Y,
        stroke: 'transparent',
        strokeWidth: 6,
    ...
    !1 !== e.draggable &&
      ...
      h ||
        (ya(
          this._selectionHittest,
          'mousedown',
          Da(this._onClickSelectionPath, this)
        ),
        ya(this._selectionHittest, 'mouseup', Da(this._onRelease, this))),
      ya(
        this._selectionHittest,
        'touchstart',
        Da(this._onClickSelectionPath, this)
    ...
    (dt.simplifySVG = function (t, e) {
      ...
      if (
        ...
        ('#' !== t.charAt(0) && '.' !== t.charAt(0)) ||
          ((n = D.querySelector(t)) && (t = n.getAttribute('d'))),
        (i =
        ...
        ;(i = pointsToSegment(simplifyPoints(i, d), e.curviness, p))[2] =
          'C' + i[2]
  ...
  function kb(t, e, n) {
    return db(t) && wt.test(t)
      ...
      : db(t) || (t && 'path' === (t.tagName + '').toLowerCase())
      ? t
      : 0
  }
  function pb(t, e) {
          ...
          var e =
              0 ===
                (window ? window.location.href : '').indexOf(
                  _a(102, 105, 108, 101, 58, 47, 47)
                ) ||
              -1 !== t.indexOf(_a(108, 111, 99, 97, 108, 104, 111, 115, 116)) ||
              -1 !== t.indexOf(_a(49, 50, 55, 46, 48, 32, 48, 46, 49)),
            n = [
              At,
              _a(99, 111, 100, 101, 112, 101, 110, 46, 105, 111),
              _a(
                99,
                111,
                100,
              ...
              _a(99, 111, 100, 101, 112, 101, 110, 46, 100, 101, 118),
              _a(99, 111, 100, 101, 112, 101, 110, 46, 97, 112, 112),
              _a(112, 101, 110, 115, 46, 99, 108, 111, 117, 100),
              _a(
                99,
                115,
                115,
              ...
              _a(99, 100, 112, 110, 46, 105, 111),
              _a(112, 101, 110, 115, 46, 105, 111),
              _a(103, 97, 110, 110, 111, 110, 46, 116, 118),
              _a(
                99,
                111,
                100,
              ...
              _a(116, 121, 109, 112, 97, 110, 117, 115, 46, 110, 101, 116),
              _a(116, 119, 101, 101, 110, 109, 97, 120, 46, 99, 111, 109),
              _a(116, 119, 101, 101, 110, 108, 105, 116, 101, 46, 99, 111, 109),
              _a(112, 108, 110, 107, 114, 46, 99, 111),
              _a(104, 111, 116, 106, 97, 114, 46, 99, 111, 109),
              _a(
                119,
                101,
                98,
              ...
              _a(97, 114, 99, 104, 105, 118, 101, 46, 111, 114, 103),
              _a(
                99,
                111,
                100,
              ...
              _a(99, 111, 100, 105, 101, 114, 46, 105, 111),
              _a(
                109,
                111,
                116,
              ...
              _a(106, 115, 102, 105, 100, 100, 108, 101, 46, 110, 101, 116),
            ],
            i = n.length;
          -1 < --i;
    ...
    t instanceof ut.core.Tween
      ...
      (r = (function _getPositionOnPage(t) {
        var e = t.getBoundingClientRect(),
          n =
            ft.clientTop -
            (pt.pageYOffset || ft.scrollTop || _t.scrollTop || 0),
          i =
            ft.clientLeft -
            (pt.pageXOffset || ft.scrollLeft || _t.scrollLeft || 0)
        return {
          left: e.left + i,
          top: e.top + n,
          right: e.right + i,
      ...
      e.center &&
        ut.set(n, { transformOrigin: '50% 50%', xPercent: -50, yPercent: -50 }),
      l
