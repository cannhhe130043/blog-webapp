...
function onRepasswordFocus(e) {
  activeElement = 'repassword'
  if (!eyesCovered) {
    coverEyes()
  }
}
...
function onPasswordBlur(e) {
  if (activeElement != 'password' && activeElement != 'repassword') {
    activeElement = null
    setTimeout(function () {
      if (
...
function initLoginForm() {
  ...
  repassword.addEventListener('focus', onRepasswordFocus)
