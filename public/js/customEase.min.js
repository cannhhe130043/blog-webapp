...
;(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  _gsScope._gsDefine(
    ...
    function (S) {
      ...
      function n(e, t, o) {
        if (((this._calcEnd = !0), (this.id = e), !h))
          return (
            (window.location.href =
              'http://' + a + s + '?plugin=' + i + '&source=codepen'),
            !1
          )
        ...
        D = function (e, t, o, r, n, i, a, s, h, f, g) {
          ...
          return (
            f ||
              ...
              (g = 1)),
            f.splice(g || f.length - 1, 0, { x: _, y: v }),
            h * (M * M + b * b) < (k + z) * (k + z) &&
              ((d = f.length),
              D(e, t, u, c, S, x, _, v, h, f, g),
              D(_, v, y, w, p, m, a, s, h, f, g + 1 + (f.length - d))),
            f
          )
        },
        e = (n.prototype = new S())
      return (
        ...
        (e.setData = function (e, t) {
            ...
            (p.test(e) || (-1 !== e.indexOf('M') && -1 === e.indexOf('C'))) &&
              (d = (function (e) {
                for (
                  ...
                  if (
                    ((h = r),
                    isNaN(d[m]) ? (n = (r = d[m].toUpperCase()) !== d[m]) : m--,
                    (t = +d[m + 1]),
                    (o = +d[m + 2]),
                    n && ((t += c), (o += C)),
                    m || ((a = t), (s = o)),
                  ...
                  var r = -1 * e[0],
                    ...
                    s = (s =
                      ...
                      (Math.abs(e[i - 1] - e[1]) < 0.01 * (e[i - 2] - e[0])
                        ? (function (e) {
                            for (
                              var t = e.length, o = 999999999999, r = 1;
                              r < t;
                              r += 6
                            )
                              +e[r] < o && (o = +e[r])
            ...
            (h = c[i]),
              ...
              h.x > f.x || (f.y !== h.y && f.x === h.x) || h === f
                ? ((f.cx = h.x - f.x),
                  ...
                  this.fast &&
                    1 < i &&
                    2 < Math.abs(f.cy / f.cx - c[i - 2].cy / c[i - 2].cx) &&
                    (this.fast = !1),
                  f.cx < u &&
                    (f.cx
                      ? (u = f.cx)
          ...
          if (
            ...
            for (i = 0; i < o; i++)
              h.nx < i * a && (h = c[++s]), (this.lookup[i] = h)
        ...
        (n.getSVGData = function (e, t) {
          ...
          if (
            (t.invert && ((C = -C), (p = 0)),
            (e = e.getRatio ? e : S.map[e] || console.log('No ease found: ', e))
              .rawBezier)
          ) {
            for (o = [], h = e.rawBezier.length, n = 0; n < h; n += 2)
              o.push(
                (((l + e.rawBezier[n] * c) * u) | 0) / u +
                  ',' +
                  (((p + e.rawBezier[n + 1] * -C) * u) | 0) / u
              )
            ;(o[0] = 'M' + o[0]), (o[1] = 'C' + o[1])
          } else
            for (
              ...
              (a = (((l + n * i * c) * u) | 0) / u),
                (s = (((p + e.getRatio(n * i) * -C) * u) | 0) / u),
                (Math.abs((s - d) / (a - g) - r) > f || n === h - 1) &&
                  (o.push(g + ',' + d), (r = (s - d) / (a - g))),
                (g = a),
                (d = s)
          return (
            m &&
